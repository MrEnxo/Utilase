...
open class FilePerProvider<Index, T>(private val Folder: File, private val indexer: (index: Index) -> String, private val serializer: Serializer<T>) : PerDataProvider<Index, T> {
